...
var Clock = function (_React$Component) {
  ...
  function Clock(args) {
    ...
    var _this = _possibleConstructorReturn(this, (Clock.__proto__ || Object.getPrototypeOf(Clock)).call(this, args));
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      var hours = this.correctDigits(this.state.time.getHours());
      var minutes = this.correctDigits(this.state.time.getMinutes());
      var seconds = this.correctDigits(this.state.time.getSeconds());
    ...
    key: 'correctDigits',
    value: function correctDigits(time) {
      if (time < 10) {
        return '0' + time;
      } else {
        return time;
  ...
  _createClass(Weather, [{
    ...
    value: function getWeather() {
      ...
      var getResponse = function getResponse() {
        var response = JSON.parse(wReq.response);
      ...
      wReq.open("GET", "http://api.openweathermap.org/data/2.5/weather?lat=" + this.latitude + "&lon=" + this.longitude + "&appid=9c6b279f1c36ece02e7dcff91eb6f67c");
      wReq.send();
    }
  }, {
    key: "componentDidMount",
